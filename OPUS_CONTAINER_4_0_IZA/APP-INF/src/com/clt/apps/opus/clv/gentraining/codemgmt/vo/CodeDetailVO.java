...
package com.clt.apps.opus.clv.gentraining.codemgmt.vo;
...
public class CodeDetailVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CodeDetailVO> models = new ArrayList<CodeDetailVO>();
	...
	public CodeDetailVO(String ibflag, String pagerows, String updDt, String updUsrId, String creDt, String creUsrId, String aplyEndDt, String aplyStDt, String intgCdValDpSeq, String intgCdValDesc, String intgCdValDpDesc, String intgCdValCtnt, String intgCdId) {
		this.updDt = updDt;
...
/**
	 ...
	 * @return CodeDetailVO[]
	 */
	public CodeDetailVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CodeDetailVO[]
	 */
	public CodeDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CodeDetailVO model = null;
	...
	public CodeDetailVO[] getCodeDetailVOs(){
		CodeDetailVO[] vos = (CodeDetailVO[])models.toArray(new CodeDetailVO[models.size()]);
		return vos;
	}
