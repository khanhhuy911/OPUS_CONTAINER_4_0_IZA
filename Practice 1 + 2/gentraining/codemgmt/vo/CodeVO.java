...
public class CodeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CodeVO> models = new ArrayList<CodeVO>();
	...
	public CodeVO(String ibflag, String pagerows, String updDt, String updUsrId, String creDt, String creUsrId, String intgCdUseFlg, String mngTblNm, String ownrSubSysCd, String intgCdLen, String intgCdDatTpNm, String intgCdTpCd, String intgCdDesc, String intgCdNm, String intgCdId) {
		this.updDt = updDt;
...
/**
	 ...
	 * @return CodeVO[]
	 */
	public CodeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CodeVO[]
	 */
	public CodeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CodeVO model = null;
	...
	public CodeVO[] getCodeVOs(){
		CodeVO[] vos = (CodeVO[])models.toArray(new CodeVO[models.size()]);
		return vos;
	}
