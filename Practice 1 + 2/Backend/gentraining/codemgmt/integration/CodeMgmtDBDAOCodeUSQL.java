...
*@FileName : CodeMgmtDBDAOCodeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDBDAOCodeUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Update data code master
	  * </pre>
	  */
	public CodeMgmtDBDAOCodeUSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgmtDBDAOCodeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
