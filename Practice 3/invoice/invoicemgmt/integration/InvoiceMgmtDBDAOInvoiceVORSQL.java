...
*@FileName : InvoiceMgmtDBDAOInvoiceVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceMgmtDBDAOInvoiceVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InvoiceMgmtDBDAOInvoiceVORSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceMgmtDBDAOInvoiceVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    WHERE NVL(STL.THEA_STL_FLG, 'N') = 'N'" ).append("\n"); 
		query.append("    AND INV.ACCT_YRMON BETWEEN REPLACE(@[date_fr],'-','') AND REPLACE(@[date_to],'-','')" ).append("\n"); 
		query.append("    #if (${jo_crr_cd}!='')" ).append("\n"); 
		query.append("        AND INV.JO_CRR_CD  IN (${jo_crr_cd})" ).append("\n"); 
		...
		query.append("              CRR.DELT_FLG         = 'N'" ).append("\n"); 
		...
		query.append(" GROUP BY GROUPING SETS((INV.JO_CRR_CD" ).append("\n"); 
		query.append("     , INV.RLANE_CD" ).append("\n"); 
		query.append("     , INV.LOCL_CURR_CD" ).append("\n"); 
		query.append("     , INV.INV_NO" ).append("\n"); 
		query.append("     , INV.CSR_NO" ).append("\n"); 
		query.append("     , INV.APRO_FLG" ).append("\n"); 
		query.append("     , INV.CUST_VNDR_CNT_CD" ).append("\n"); 
		query.append("     , INV.CUST_VNDR_SEQ , INV.PRNR_REF_NO , INV.CUST_VNDR_ENG_NM)," ).append("\n"); 
		query.append("(INV.LOCL_CURR_CD, INV.INV_NO)," ).append("\n"); 
		query.append("(INV.LOCL_CURR_CD))" ).append("\n"); 
