...
*@FileName : InvoiceDTLVO.java
*@FileTitle : InvoiceDTLVO
*Open Issues :
*Change history :
...
package com.clt.apps.opus.clv.invoice.invoicemgmt.vo;
...
public class InvoiceDTLVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<InvoiceDTLVO> models = new ArrayList<InvoiceDTLVO>();
	...
	public InvoiceDTLVO(String ibflag, String pagerows, String joCrrCd, String rlaneCd, String loclCurrCd, String invNo, String csrNo, String aproFlg, String custVndrCntCd, String custVndrSeq, String prnrRefNo, String custVndrEngNm, String invRevActAmt, String invExpActAmt, String revExp, String item) {
		this.csrNo = csrNo;
...
/**
	 ...
	 * @return InvoiceDTLVO[]
	 */
	public InvoiceDTLVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return InvoiceDTLVO[]
	 */
	public InvoiceDTLVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		InvoiceDTLVO model = null;
	...
	public InvoiceDTLVO[] getInvoiceDTLVOs(){
		InvoiceDTLVO[] vos = (InvoiceDTLVO[])models.toArray(new InvoiceDTLVO[models.size()]);
		return vos;
	}
